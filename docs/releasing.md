...
```bash
gh attestation verify path/to/rankweave-0.16.0-py3-none-any.whl \
  --repo ContextualWisdomLab/RankWeave

gh attestation verify path/to/rankweave-0.16.0.tar.gz \
  --repo ContextualWisdomLab/RankWeave
```
